...
(function(){if ("intervalNumber" in window) {trash = clearInterval(window.intervalNumber);trash = delete window.intervalNumber;}else{begin = (function begin(){window.intervalNumber = setInterval(function(){window.scrollBy(0,1);},delay=300);});begin();}})();
