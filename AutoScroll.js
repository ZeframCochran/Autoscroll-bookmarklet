...
(function(){if ("intervalNumber" in window) {clearInterval(window.intervalNumber);delete window.intervalNumber;}else{begin = (function begin(){window.intervalNumber = setInterval(function(){window.scrollBy(0,1);},delay=300);});begin();}})();
